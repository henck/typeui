...
var StandardInputBase = /** @class */ (function (_super) {
    ...
    StandardInputBase.prototype.render = function () {
        var p = this.props;
        return (React.createElement("input", { className: this.props.className, value: p.value == null ? '' : p.value, placeholder: p.placeholder, disabled: p.disabled, type: p.type, maxLength: p.maxLength, onChange: this.handleChange, onFocus: this.props.onFocus }));
    };
