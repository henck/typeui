...
<Canvas>
  <Story
    name="align"
    args={{direction: 'down', maxItems: 4, data: ages, placeholder: "Select person", label: (item) => item.name, onSearch: null}}>
    {AlignTemplate.bind({})}
  </Story>
</Canvas>
...
The `gap` between columns in the body can be adjusted. By default it's `16` pixels.

<Canvas>
  <Story
    name="gap"
    args={{direction: 'down', maxItems: 4, data: ages, gap: 0, placeholder: "Select person", label: (item) => item.name, onSearch: null}}>
    {AlignTemplate.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="clearable"
    args={{clearable: true, direction: 'down', maxItems: 4, data: people, placeholder: "Select person", label: (item) => item.name, onSearch: null}}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="fluid"
    args={{fluid: true, direction: 'down', maxItems: 4, data: people, placeholder: "Select person", label: (item) => item.name, onSearch: null}}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="inline"
    args={{inline: true, direction: 'down', maxItems: 4, data: people, placeholder: "Select person", label: (item) => item.name, onSearch: null}}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="maxItems"
    args={{direction: 'down', maxItems: 8, data: data, placeholder: "Select domain", label: (item) => item.name, onSearch: null}}>
    {Template.bind({})}
  </Story>
</Canvas>
...
<Canvas>
  <Story
    name="onSearch"
    args={{direction: 'down', maxItems: 4, data: people, placeholder: "Select person", label: (item) => item.name, onSearch: () => {} }}>
    {Template.bind({})}
  </Story>
</Canvas>
