...
storiesOf('Controls/Accordion/States', module)
  .addDecorator(withInfo({...withInfoSettings, propTables: false}))
  .addDecorator(withStyledComponents)
  .addDecorator(withKnobs)
  .addParameters({
    info: `
    An accordion's tab can be \`hidden\`.
    `
  })
  .addWithJSX(
    'Hidden',
  ...
  <Accordion 
    ...
    <Accordion.Tab title="What kinds of dogs are there?" hidden={boolean('hidden', true, 'State')}>
