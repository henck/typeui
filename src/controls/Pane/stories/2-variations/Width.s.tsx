  ...
  render() {
    return (
      <div style={{position: 'relative', display: 'inline-block'}}>
        ...
        <Pane padded width={800} open={this.state.open} onClose={this.handleClose}>
...
storiesOf('Pane/Variations', module)
  .addDecorator(withInfo({...withInfoSettings, propTables: false}))
  .addDecorator(withStyledComponents)
  .addDecorator(withKnobs)
  .addParameters({
    info: `
    By default, a \`Pane\` has a width of 400px. The \`width\` attribute overrides this.
    `
  })
  .addWithJSX(
    'Width',
